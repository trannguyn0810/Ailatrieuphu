...
import com.bkacad.nnt.ailatrieuphu.dialogs.AudienceDialog;
import com.bkacad.nnt.ailatrieuphu.dialogs.CallDialog;
import com.bkacad.nnt.ailatrieuphu.dialogs.NoticeDialog;
import com.bkacad.nnt.ailatrieuphu.dialogs.ScoreDialog;
import com.bkacad.nnt.ailatrieuphu.layout.MoneyLayout;
import com.bkacad.nnt.ailatrieuphu.manage.DatabaseManager;
import com.bkacad.nnt.ailatrieuphu.manage.MusicManager;
import com.bkacad.nnt.ailatrieuphu.model.Question;
...
public class PlayerActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(final View v) {
        if (v.getId() == R.id.tv_case_a) {
            ...
            stopGame();
        } else if (v.getId() == R.id.iv_player) {
            drawerLayout.openDrawer(GravityCompat.START);
        ...
        } else if (v.getId() == R.id.btn_audience) {

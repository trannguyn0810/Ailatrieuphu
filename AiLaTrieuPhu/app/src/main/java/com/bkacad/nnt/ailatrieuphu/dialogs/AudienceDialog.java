...
public class AudienceDialog extends Dialog {
    ...
    public AudienceDialog(Context context) {
        ...
        present[0] = findViewById(R.id.tv_pesent_1);
        present[1] = findViewById(R.id.tv_pesent_2);
        present[2] = findViewById(R.id.tv_pesent_3);
        present[3] = findViewById(R.id.tv_pesent_4);
